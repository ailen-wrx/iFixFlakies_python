...
#        patch_length=len(patched_victim_node.body)-len(victim_offset     
#        print(victim_start_lineno,'}}}}}}}}}}}}}}}}}}}}')
        ...
        for each in tmp_content.split('\n'):
            ...
            if each !='':
                patch_offset+=1
                print(patch_offset,str(each),len(each))
    
        
        print(len(tmp_content.split('\n')))
        print(tmp_content,'::::::::::::::::;')
        print('@@@@@@@@@@@@@@@@@')
